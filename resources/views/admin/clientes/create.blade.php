            ...
            <form action="{{ route('admin.clientes.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Celular (Formato internacional)</label><span class="text-danger">*</span>
                                <input type="tel"
                                       id="celular"
                                       class="form-control"
                                       name="celular"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="direccion"
                                       value="{{ old('direccion') }}"
                                       placeholder="Ej: |Zona, Calle, #Casa|Sin Agarrador|Sale Afuera|Confirmar:no| "
                                       required>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    celularInput.addEventListener('blur', function () {
        if (celularValido) {
            validarCampo('celular', this.value, celularInput, celularFeedback);
        }
    });
