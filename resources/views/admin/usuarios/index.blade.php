                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a href="{{url('/admin/usuarios/'.$user->id.'/edit')}}" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i> Editar</a>
                                            <form action="{{url('/admin/usuarios',$user->id)}}" method="post"
                                                  onclick="preguntar{{$user->id}}(event)" id="miFormulario{{$user->id}}">
                                                @csrf
                                                @method('DELETE')
