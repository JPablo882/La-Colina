...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'can' => 'admin.especiales.index',
            'text' => 'Descuestos',
            'url' => 'admin/especiales',
            'icon' => 'fas fa-percent',
            'classes' => 'bg-blue text-white',
        ],
        ...
        [
            'can' => 'admin.contabilidad.confirmar_venta.create',
            'text' => 'Confirmacion Ventas',
            'url' => 'admin/contabilidad/confirmar-venta',
            'icon' => 'fas fa-check-circle',
            'classes' => 'bg-blue text-white',
        ],

        [
            'can' => 'admin.contabilidad.historial_cierres',
            'text' => 'Historial Confirmacion',
            'url' => 'admin/contabilidad/historial_cierres',
            'icon' => 'fas fa-history',
            'classes' => 'bg-blue text-white',
        ],

        [
            'can' => 'admin.contabilidad.movimientos.index',
            'text' => 'Registro Contabilidad',
            'url' => 'admin/contabilidad/movimientos',
        ...
        [
            'can' => 'admin.contabilidad.movimientos.resumen',
            'text' => 'Resumen Contabilidad',
            'url' => 'admin/contabilidad/movimientos/resumen',
